...
import { updateCustomerThunk } from '../../../../store/slices/customer/customer.thunk';
...
export const EditCustomerPage = () => {
  ...
  const { state }: { state: CustomerModel } = useLocation();
              ...
              <FormControl fullWidth>
                <DatePicker
                  ...
                  onChange={(date: Dayjs | null) => {
                    formik.setFieldValue('birthday', dayjs(date));
                  }}
                />
              </FormControl>
            </Grid>
